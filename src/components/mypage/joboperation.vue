  ...
  export default {
    ...
    methods: {
      async submitBtn () {
        ...
        const res = await Home.postCreate(this.job_name, this.company, this.price, this.job_number, this.place, this.eat, this.live, this.company_info, this.job_require)
